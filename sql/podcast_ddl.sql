...
CREATE TABLE podcast_ingest (
    ...
    , hash_record                                                               TEXT                                        NOT NULL           -- hash of the entire file read as a string
    , hash_title                                                                TEXT                                        NOT NULL           -- hash of the title field
    , hash_description                                                          TEXT                                        NOT NULL           -- hash of the description field
    , podcast_uuid                                                              UUID                                        NOT NULL
    , PRIMARY KEY (podcast_ingest_id)
);
CREATE UNIQUE INDEX idx_podcast_ingest_podcast_uuid                             ON podcast_ingest                                   USING btree (podcast_uuid);
--
-- Podcasts
--
...
CREATE TABLE podcast_purgatory (
    ...
    , date_processed                                                            TIMESTAMPTZ                                          DEFAULT CURRENT_TIMESTAMP
...
-- Show
--
DROP TABLE IF EXISTS show_purgatory CASCADE;
CREATE TABLE show_purgatory (
      show_purgatory_id                                                      INTEGER                                    	NOT NULL GENERATED BY DEFAULT AS IDENTITY
    , show_uuid                                                             	UUID                                        NOT NULL
    , date_created                                                              TIMESTAMPTZ                                 NOT NULL DEFAULT CURRENT_TIMESTAMP
    , date_modified                                                             TIMESTAMPTZ                                 NOT NULL DEFAULT CURRENT_TIMESTAMP
    , is_explicit                                                               BOOLEAN                                     NOT NULL
    , index_status                                                              INTEGER                                     NOT NULL DEFAULT 310   CHECK(index_status IN (310, 320, 330)) -- 1=AUTO 2=MANUAL 3=EXCLUDED
...
CREATE INDEX idx_show_purgatory_show_purgatory_id                         ON show_purgatory                        USING btree (show_purgatory_id);


DROP TABLE IF EXISTS show_quarantine CASCADE;
CREATE TABLE show_quarantine (
      show_quarantine_id                                                     INTEGER                                     NOT NULL GENERATED BY DEFAULT AS IDENTITY
    , date_processed                                                            TIMESTAMPTZ                                 NOT NULL DEFAULT CURRENT_TIMESTAMP
    , show_uuid                                                              UUID                                        NOT NULL
    , original_show_uuid                                                     UUID                                        NOT NULL
    , PRIMARY KEY (show_quarantine_id)
);
CREATE UNIQUE INDEX idx_show_quarantine_podcast_uuid       					ON show_quarantine    					USING btree (show_uuid);


DROP TABLE IF EXISTS show_quality CASCADE;
CREATE TABLE show_quality (
       show_quality_id                                                       INTEGER                                     NOT NULL GENERATED BY DEFAULT AS IDENTITY
    ,  show_uuid                                                             UUID                                        NOT NULL
    , date_created                                                              TIMESTAMPTZ                                 NOT NULL DEFAULT CURRENT_TIMESTAMP
    , date_modified                                                             TIMESTAMPTZ                                 NOT NULL DEFAULT CURRENT_TIMESTAMP
    , is_explicit                                                               BOOLEAN                                     NOT NULL
...
CREATE UNIQUE INDEX idx_show_quality_show_uuid       						ON show_quality    						USING btree (show_uuid);
--
-- Station
--
...
DROP TABLE IF EXISTS episode_quarantine CASCADE;
CREATE TABLE episode_quarantine (
      episode_quarantine_id                                                     INTEGER                                     NOT NULL GENERATED BY DEFAULT AS IDENTITY
    , date_processed                                                            TIMESTAMPTZ                                 NOT NULL DEFAULT CURRENT_TIMESTAMP
    , episode_uuid                                                              UUID                                        NOT NULL
    , original_episode_uuid                                                     TEXT                                        NOT NULL
    , duplicate_file_name                                                       TEXT                                		NOT NULL
...
CREATE TABLE episode_quality (
    ...
    , uuid_selector                                                             SMALLINT                                    NOT NULL DEFAULT 410   CHECK(uuid_selector IN (410, 420, 430)) -- 410 -> Native, 420 -> String, 430 -> URL
    , date_created                                                              TIMESTAMPTZ                                 NOT NULL DEFAULT CURRENT_TIMESTAMP
    , date_modified                                                             TIMESTAMPTZ                                 NOT NULL DEFAULT CURRENT_TIMESTAMP
    , description_selected                                                      INTEGER                                     NOT NULL        -- 110=Cleaned, 120=ChatGPT
    , readability                                                               INTEGER                                     NOT NULL DEFAULT 0
